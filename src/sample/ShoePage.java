...
public class ShoePage implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        item_01_price_tv.setText(""+Controller.op.getPrices().get(2));
        item_02_price_tv.setText(""+Controller.op.getPrices().get(3));
    }
}
