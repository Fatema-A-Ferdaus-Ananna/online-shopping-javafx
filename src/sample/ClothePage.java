...
public class ClothePage implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        item_01_price_tv.setText(""+Controller.op.getPrices().get(0));
        item_02_price_tv.setText(""+Controller.op.getPrices().get(1));
    }
}
